...
docker run -v /mnt/DATA/TUV/tailored-report-tv:/Tailored --rm --cpuset-cpus="17-32" report_tv /bin/bash -c ". /opt/miniconda/bin/activate; cd /Tailored/codes; python main_run_operational.py"
